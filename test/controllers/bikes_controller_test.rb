...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { color: @bike.color, image: @bike.image, make: @bike.make, model: @bike.model, user_id: @bike.user_id } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { color: @bike.color, image: @bike.image, make: @bike.make, model: @bike.model, user_id: @bike.user_id } }
